...
?><div class="content-about__content">
 ...
 <strong class="content-delivery__subtitle">Бесплатно<br>
					<br>
					<br>
					</strong>
					<p class="content-delivery__text">
						Самовывоз из <a href="/kontakty/">магазинов</a> в Москве
					</p>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-4 content-delivery__block">
 <strong class="content-delivery__subtitle">400 руб.<br>
					<br>
					<br>
					</strong>
					<p class="content-delivery__text">
						Доставка по Москве в пределах МКАД + Бутово
					</p>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-4 content-delivery__block">
 <strong class="content-delivery__subtitle">400 руб.<br>
 ...
 <strong class="content-delivery__title">Почта России<br>
					<br>
					</strong> <strong class="content-delivery__subtitle">500 руб.</strong>
					<p class="content-delivery__text">
						посылка до 3 кг.
					</p>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 content-delivery__block_half">
 <strong class="content-delivery__title">Транспортная компания<br>
					<br>
					</strong> <strong class="content-delivery__subtitle">400 руб. доставка до ТК<br>
					+ тариф ТК до места</strong>
					<p class="content-delivery__text">
						Тариф ТК до места оплачивается представителю ТК во время получения посылки.
					</p>
				</div>
			</div>
		</div>
