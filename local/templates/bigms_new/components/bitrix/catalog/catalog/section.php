...
$('.seo_text').readmore({
 speed: 100,
 maxHeight: 100,
moreLink: '<a class="button content-promo" href="#">Показать описание полностью</a>',
lessLink: '<a class="button content-promo open" href="#">Свернуть описание</a>'
});
</script>
</section>
				<?elseif($SEO_TEXT):?>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-lg-offset-1 col-md-offset-1 col-sm-offset-1 content__filter">
            <?$APPLICATION->ShowViewContent("right_area")?>
					...
					<strong class="content-adv__title">Сэкономьте до 30% на сантехнике за счет исправления<br>ошибок в смете</strong>
					<div class="content-adv__buttons">
					  <a href="/smeta/" class="button button_yel content-adv__button">Расчёт сметы</a>
					  <a href="" class="button content-adv__button content-adv__button_detail">Подробнее</a>
					</div>
					<div class="content-adv__dropdown">
					  <p class="content-adv__text">Мы отлично знаем, как составляются сметы и какие в них бывают ошибки.<br>Оперативно проверим Вашу смету и поможем сэкономить на комплектующих:</p>
