            ...
            <div class="content-product">
                <div class="content-product__tabs product-tabs tabs">
					...
					<div data-tab="all" class="product-tabs__content tabs__content active">
						...
						<?if ( count($arResult["PROPERTIES"]["RECOMMEND"]["VALUE"]) > 0 && $arResult["PROPERTIES"]["RECOMMEND"]["VALUE"][0]):?>
							<?
							...
							<section class="products-similar">
								<strong class="products-similar__title content-product__title">С этим товаром покупают</strong>
